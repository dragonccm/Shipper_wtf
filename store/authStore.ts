    ...
    (set, get) => ({
      ...
      checkAuth: async () => {
        ...
        try {
          ...
          if (token) {
            const res = await fetch("https://wise-apes-wear.loca.lt/api/check-auth", {
              headers: {
      ...
      login: async (phoneNumber: string, password: string) => {
        ...
        set({ isLoading: true });
        try {
          const res = await fetch("https://wise-apes-wear.loca.lt/api/login_phone", {
            method: "POST",
            headers: {
      ...
      register: async (phoneNumber: string, password: string, name: string) => {
        ...
        set({ isLoading: true });
        try {
          const res = await fetch("https://wise-apes-wear.loca.lt/api/register_phone", {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
